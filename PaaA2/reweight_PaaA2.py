...
save            = True
to_remove       = ['HA2', 'HA3']
reweighting_keys = ['CA', 'CB','HA','H','N','SAXS','RDC']
blk_start = 2
blk_stop = 500
blk_step = 100
#blk_start = 10
...
reweighting_keys = [['CA','CB','N','H', 'SAXS','RDC']]
print('Reweighting keys: {}'.format(reweighting_keys))
