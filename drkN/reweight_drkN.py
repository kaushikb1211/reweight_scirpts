...
theta_0 = { 'HA': 1., 'CA': 1, 'CB': 1., 'C':  1., 'H':  1.,'HA2': 1., 'HA3': 1., 'N': 1., 'RDC': 1., 'Rg': 1., 'JHNHA': 1., 'SAXS' : 1., 'PRE_2' : 1, 'PRE_59' :1.}
theta_break     = False
rew_break       = False
save            = True
to_remove       = ['HA2', 'HA3', 'N']
reweighting_keys = ['CA', 'CB','H','C', 'PRE_2', 'PRE_59', 'JHNHA', 'SAXS']
blk_start = 2
blk_stop = 500
blk_step = 100
#blk_start = 10
...
# Gyration radium
expdata=add_exp_scalar(1.67,expdata,'Rg')
...
compdata=add_md_data(datadir+'/J_HNHA1.all.csv',compdata,'JHNHA')
...
kish_mini = 20
Kish_keys = ['CA', 'CB', 'H', 'C', 'PRE_2', 'PRE_59', 'JHNHA', 'SAXS']
Kish_ratio_vals = []
